...
voices["nakumo"]=https://studio-neutrino.com/downloads/v${NEUTRINO_PV}/%E3%83%8A%E3%82%AF%E3%83%A2%EF%BC%88NEUTRINO-Library%EF%BC%89-v${PV}-beta.zip
...
voices["yoko"]=https://studio-neutrino.com/downloads/v${NEUTRINO_PV}/%E8%AC%A1%E5%AD%90%EF%BC%88NEUTRINO-Library%EF%BC%89-v${PV}.zip
voices["jsut"]=https://studio-neutrino.com/downloads/v${NEUTRINO_PV}/JSUT%EF%BC%88NEUTRINO-Library%EF%BC%89-v${PV}.zip
