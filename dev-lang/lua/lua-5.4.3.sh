...
make linux PLAT=linux MYCFLAGS="-DPIC -fPIC" MYLDFLAGS="${LDFLAGS}" MYLIBS="-lncurses" INSTALL_TOP="/pkg/main/${PKG}.core.${PVRF}" INSTALL_INC="/pkg/main/${PKG}.dev.${PVRF}/include" INSTALL_LIB="/pkg/main/${PKG}.libs.${PVRF}/lib" INSTALL_MAN="/pkg/main/${PKG}.doc.${PVRF}/man/man1"
