...
make linux PLAT=linux MYLDFLAGS="${LDFLAGS}" MYLIBS="-lncurses" INSTALL_TOP="/pkg/main/${PKG}.core.${PVR}" INSTALL_INC="/pkg/main/${PKG}.dev.${PVR}/include" INSTALL_LIB="/pkg/main/${PKG}.libs.${PVR}/lib" INSTALL_MAN="/pkg/main/${PKG}.doc.${PVR}/man/man1"
