...
importpkg dev-libs/libunistring zlib sys-libs/readline

docmake -DUSE_DOCTEST=OFF -DUSE_MULTIMEDIA=ffmpeg -DUSE_PANDOC=OFF -DUSE_QRCODEGEN=OFF -DUSE_STATIC=OFF
