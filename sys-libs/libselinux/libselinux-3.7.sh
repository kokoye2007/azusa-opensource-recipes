...
CPPFLAGS="${CPPFLAGS} -DPIE -fPIE -fPIC -fno-semantic-interposition -Wno-stringop-truncation"
...
MAKEOPTS=(
	...
	LIBDIR="/pkg/main/${PKG}.dev.${PVRF}/lib$LIB_SUFFIX"
	INCLUDEDIR="/pkg/main/${PKG}.dev.${PVRF}/include"
	SHLIBDIR="/pkg/main/${PKG}.libs.${PVRF}/lib$LIB_SUFFIX"
	DESTDIR="${D}"
)
...
sed -i -re 's/^Libs:(.*)/Libs:\1 -lpcre2-8/' "${D}/pkg/main/${PKG}.dev.${PVRF}/lib${LIB_SUFFIX}/pkgconfig/libselinux.pc"
