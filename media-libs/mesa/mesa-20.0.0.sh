...
meson --prefix="/pkg/main/${PKG}.core.${PVRF}" -Dbuildtype=release -Ddri-drivers=$DRI_DRIVERS -Dgallium-drivers=$GALLIUM_DRV -Dgallium-nine=false -Dglx=dri -Dosmesa=gallium -Dvalgrind=false "${CHPATH}/${P}"
