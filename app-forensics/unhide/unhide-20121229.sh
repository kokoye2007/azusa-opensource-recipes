...
mv -v unhide unhide-tcp "${D}/pkg/main/${PKG}.core.${PVR}/bin"

mkdir -pv "${D}/pkg/main/${PKG}.doc.${PVR}/man"
cp -v changelog README.txt TODO LEEME.txt LISEZ-MOI.TXT NEWS "${D}/pkg/main/${PKG}.doc.${PVR}"
cp -v -r man "${D}/pkg/main/${PKG}.doc.${PVR}/man/man8"
