...
importpkg \
	...
	sys-process/numactl dev-util/cunit dev-libs/libaio dev-db/sqlite dev-libs/leveldb app-arch/snappy app-arch/lz4 \
	...
	net-libs/rabbitmq-c dev-libs/librdkafka dev-libs/pmdk
