...
get https://github.com/llvm/llvm-project/releases/download/llvmorg-${PV}/cfe-${PV}.src.tar.xz
...
export LD_LIBRARY_PATH=/pkg/main/sys-devel.llvm.dev.${PV}/lib64
export LLVM_DIR=/pkg/main/sys-devel.llvm.dev.${PV}/lib64/cmake/llvm

cmake ${CHPATH}/cfe-${PV}.src -DLLVM_CONFIG=/pkg/main/sys-devel.llvm.dev.${PV}/bin/llvm-config -DCMAKE_INSTALL_PREFIX=/pkg/main/${PKG}.dev.${PVR} -DLLVM_ENABLE_TERMINFO=ON \
