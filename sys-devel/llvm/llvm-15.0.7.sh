...
# fix ld.lld: error: version script assignment of 'LLVM_15' to symbol 'LLVMCreateDisasm' failed: symbol not defined
export CPPFLAGS="${CPPFLAGS} -Wl,--undefined-version"
