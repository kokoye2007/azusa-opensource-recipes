...
install -v -m 755 c-client/libc-client.so.1.0.0 "${D}/pkg/main/${PKG}.libs.${PVR}/lib$LIB_SUFFIX"
ln -snfv libc-client.so.1.0.0 "${D}/pkg/main/${PKG}.libs.${PVR}/lib$LIB_SUFFIX/libc-client.so.1"
ln -snfv libc-client.so.1.0.0 "${D}/pkg/main/${PKG}.libs.${PVR}/lib$LIB_SUFFIX/libc-client.so"

mkdir -p "${D}/pkg/main/${PKG}.dev.${PVR}/include/imap"
install -v -m 644 ./c-client/*.h "${D}/pkg/main/${PKG}.dev.${PVR}/include/imap"
install -v -m 644 ./c-client/linkage.c "${D}/pkg/main/${PKG}.dev.${PVR}/include/imap"
install -v -m 644 ./src/osdep/tops-20/shortsym.h "${D}/pkg/main/${PKG}.dev.${PVR}/include/imap"
