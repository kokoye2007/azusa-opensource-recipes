...
#cp -v gdk-pixbuf/loaders.cache "${D}/pkg/main/${PKG}.core.${PVR}/lib$LIB_SUFFIX"/gdk-pixbuf-*/2.*/loaders.cache
#"${D}/pkg/main/${PKG}.core.${PVR}/bin/gdk-pixbuf-query-loaders" > "${D}/pkg/main/${PKG}.core.${PVR}/lib$LIB_SUFFIX"/gdk-pixbuf-*/2.*/loaders.cache
